<?php include "../php/view_tap_table.php"; ?>
<!DOCTYPE html>
<html>
<head>
	<title>View</title>
	...
	<section class="hero">
		<div class="text">
			<div class="container_wdd">
				<div class="box">
					<h4 class="display-4 text-center">View Taps</h4><br>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="edit_taps.php?id=<?=$rows['id']?>"
												...
												<a href="../php/delete_tap_table.php?id=<?=$rows['id']?>"
					...
					<div class="py-5 text-center">
						<a href="invwdd_tools.php" class="link bounce-in-on-hover">
							<!--	ADD SIGN	-->
