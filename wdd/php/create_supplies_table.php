...
if (isset($_POST['create'])) {
	...
	if (empty($type)) {
		header("Location: ../supplies/invwdd_supplies.php?error = Type is required & $user_data");
	} else if (empty($location)) {
		header("Location: ../supplies/invwdd_supplies.php?error = Location is required & $user_data");
	} else if (empty($quantity)) {
		header("Location: ../supplies/invwdd_supplies.php?error = Quantity is required & $user_data");
	} else {
