...
$query_locations = "SELECT * FROM rawmaterial";
$query_qty = "SELECT * FROM rawmaterial";
$result_locations = mysqli_query($pass, $query_locations);
$result_qty = mysqli_query($pass, $query_qty);
?>
<!DOCTYPE html>
              ...
              <form action="php/create_jb_table.php"
               ...
               <div class="form-group">
                 <select id="partid"
                   ...
                   <option value="<?php echo $row1[7];?>"><?php echo $row1[7];?></option>
                 <?php endwhile; ?>
                 </select>
               </div>
               <!--   QUANTITY   -->
               <div class="form-group">
                 <select id="quantity"
                         ...
                         value="<?php if(isset($_GET['quantity']))
                                         echo($_GET['quantity']); ?>">
                   <?php
                   while($row1 = mysqli_fetch_array($result_qty)):;?>
