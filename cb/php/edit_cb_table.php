...
if (isset($_GET['id'])) {
	...
	if (empty($departid)) {
		header("Location: ../cbin_folder/edit_bin.php?id = $id & error = Error: 'Department' is missing");
       ...
       if ($result) {
          ...
          header("Location: ../cbin_folder/edit_bin.php?id = $id & error = Unknown Error Occurred & $user_data" . mysqli_connect_error());
       }
	}
} else {
	header("Location: view_cb_table.php");
